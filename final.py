...
def main():
    ...
    # Allow user to select PDF type: Structured or Unstructured
    pdf_type = st.sidebar.radio("Select PDF Type:", ["Structured", "Unstructured"])
    ...
    if uploaded_file is not None:
        ...
        if pdf_type == "Structured":
            st.write("Structured PDF selected.")
            headings_content_df, tables = extract_headings_and_content(pdf_path)
        else:
            st.write("Unstructured PDF selected.")
            # Add logic to convert unstructured PDF to structured PDF
            headings_content_df, tables = extract_headings_and_content(pdf_path)
